    ...
    return (
        <div>
            <div className="text-center px-5 bg-gradient-to-b from-[#152a64] to-gray-900">
                ...
                <p className="lg:text-3xl text-2xl leading-tight  text-gray-400 mt-5">Cari kode yang <span className="text-sky-500">terlupakan</span> atau mulai belajar koding sekarang.</p>
            </div>
            {/*  */}
